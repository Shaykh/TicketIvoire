...
public class GetAllPropositionsQueryHandlerTests
{
    ...
    public async Task GivenHandle_WhenQuery_ThenReturnCorrectResponse()
    {
        ...
        propositionEvenementRepositoryMock.Setup(r => r.GetAllAsync(null, null))
        ...
        propositionEvenementRepositoryMock.Verify(r => r.GetAllAsync(query.PageNumber, query.NumberByPage),
            Times.Once);
    }
}
