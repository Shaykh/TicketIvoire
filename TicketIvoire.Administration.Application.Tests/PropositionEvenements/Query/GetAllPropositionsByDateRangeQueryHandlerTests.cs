...
public class GetAllPropositionsByDateRangeQueryHandlerTests
{
    ...
    public async Task GivenHandle_WhenValidQuery_ThenReturnCorrectResponse()
    {
        ...
        propositionEvenementRepositoryMock.Setup(r => r.GetAllByDateRangeAsync(query.DateDebut, query.DateFin, CancellationToken.None))
        ...
        propositionEvenementRepositoryMock.Verify(r => r.GetAllByDateRangeAsync(query.DateDebut, query.DateFin, CancellationToken.None),
            Times.Once);
    }
    ...
    public async Task GivenHandle_WhenInvalidQuery_ThenThrowException()
    {
        ...
        propositionEvenementRepositoryMock.Verify(r => r.GetAllByDateRangeAsync(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<CancellationToken>()),
            Times.Never);
    }
}
