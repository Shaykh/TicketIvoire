...
public class GetAllPropositionsByDecisionQueryHandlerTests
{
    ...
    public async Task GivenHandle_WhenValidQuery_ThenReturnCorrectResponse()
    {
        ...
        propositionEvenementRepositoryMock.Setup(r => r.GetAllByDecisionCodeAsync(query.DecisionCode, null, null, CancellationToken.None))
        ...
        propositionEvenementRepositoryMock.Verify(r => r.GetAllByDecisionCodeAsync(query.DecisionCode, query.PageNumber, query.NumberByPage, CancellationToken.None),
            Times.Once);
    }
    ...
    public async Task GivenHandle_WhenInvalidQuery_ThenThrowException()
    {
        ...
        propositionEvenementRepositoryMock.Verify(r => r.GetAllByDecisionCodeAsync(It.IsAny<string>(), It.IsAny<uint?>(), It.IsAny<uint?>(), It.IsAny<CancellationToken>()),
            Times.Never);
    }
}
